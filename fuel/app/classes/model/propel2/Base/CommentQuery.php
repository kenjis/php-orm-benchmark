...
use propel2\Map\CommentTableMap;
 ...
 *
 * @method     \propel2\PostQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildComment findOneByCreatedAt(int $created_at) Return the first ChildComment filtered by the created_at column
 * @method     ChildComment findOneByUpdatedAt(int $updated_at) Return the first ChildComment filtered by the updated_at column *
 ...
 * @method     ChildComment requireOneByCreatedAt(int $created_at) Return the first ChildComment filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildComment requireOneByUpdatedAt(int $updated_at) Return the first ChildComment filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildComment[]|ObjectCollection findByCreatedAt(int $created_at) Return ChildComment objects filtered by the created_at column
 * @method     ChildComment[]|ObjectCollection findByUpdatedAt(int $updated_at) Return ChildComment objects filtered by the updated_at column
...
abstract class CommentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \propel2\Base\CommentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\propel2\\Comment', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, post_id, body, created_at, updated_at FROM comment WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query by a related \propel2\Post object
     *
     * @param \propel2\Post|ObjectCollection $post The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($post instanceof \propel2\Post) {
            return $this
            ...
            throw new PropelException('filterByPost() only accepts arguments of type \propel2\Post or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \propel2\PostQuery A secondary query class using the current class as primary query
     */
    public function usePostQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPost($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Post', '\propel2\PostQuery');
    }
