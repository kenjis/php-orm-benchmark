...
abstract class Comment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel2\\Map\\CommentTableMap';
    ...
    /**
     * Initializes internal state of propel2\Base\Comment object.
     */
     ...
     * @return $this|\propel2\Comment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel2\\Comment'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel2\Comment The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel2\Comment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel2\Comment Clone of current object.
     * @throws PropelException
     */
