...
abstract class Post implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\models\\Map\\PostTableMap';
    ...
    /**
     * Initializes internal state of propel\models\Base\Post object.
     */
     ...
     * @return $this|\propel\models\Post The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\models\\Post'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\models\Post
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\models\Post The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\models\Post (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\models\Post Clone of current object.
     * @throws PropelException
     */
